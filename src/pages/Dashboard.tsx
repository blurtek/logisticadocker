...
import { Plus, Clock, MapPin, Phone, Package, TrendingUp, AlertCircle, CheckCircle, Euro } from 'lucide-react';
...
const Dashboard: React.FC = () => {
  ...
  const fetchDeliveries = async () => {
    try {
      ...
      const pendingPayments = allDeliveries.filter((d: Delivery) => !d.isPaid && d.paymentAmount && d.paymentAmount > 0).length;
      const totalAmount = allDeliveries.reduce((sum: number, d: Delivery) => sum + (d.paymentAmount || 0), 0);
